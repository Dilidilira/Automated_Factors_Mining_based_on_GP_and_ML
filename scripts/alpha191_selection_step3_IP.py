...
import numpy as np
import pandas as pd
from alpha191_selection_step2_Corr import correlation_heatmap,corr_filter
"""
...
#导入冗余因子群
high_corr_df= pd.read_csv('/hdd/hdd1/cji/Trees/alphas191_corr.csv')
...
stats=pd.read_csv('/hdd/hdd1/cji/alphas191_stats.csv')
...
non_redundant_factors=pd.read_csv('/hdd/hdd1/cji/Trees/independent_factors.csv')
...
pd.DataFrame(non_redundant_factors, columns=["Factor_Index"]).to_csv('/hdd/hdd1/cji/Trees/Non_redundant_factors.csv', index=False)
